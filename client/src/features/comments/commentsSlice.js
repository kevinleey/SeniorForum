...
export const commentsSlice = createSlice({
  ...
  reducers: {
    ...
    commentUpdated: (state, action) => {
      ...
      const commentIndex = state.comments.findIndex(comment => comment.postId === postId && comment._id === _id);
...
export const { setCurrentPostId, commentAdded, commentUpdated } = commentsSlice.actions;
