              ...
              <div id="form-container">
                <label>
                  ...
                  <div className="input-form">
                    ...
                    />
                    <span className ={`char-remaining ${firstNameError && "error-message"}`}>
                ...
                <label>
                  ...
                  <div className="input-form">
                    ...
                    />
                    <span className={`char-remaining ${lastNameError && "error-message"}`}>
                ...
                />
                    <span className={`char-remaining ${bioError && "error-message"}`}>
