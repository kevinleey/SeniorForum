...
function AddPostForm() {
  ...
  const allCategories = [
    POST_CATEGORIES.CATEGORY_1.CATEGORY_TITLE,
    POST_CATEGORIES.CATEGORY_2.CATEGORY_TITLE,
    POST_CATEGORIES.CATEGORY_3.CATEGORY_TITLE,
    POST_CATEGORIES.CATEGORY_5.CATEGORY_TITLE,
    POST_CATEGORIES.CATEGORY_6.CATEGORY_TITLE,
    POST_CATEGORIES.CATEGORY_LAST.CATEGORY_TITLE,
  ];
